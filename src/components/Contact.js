            ...
            <SectionReveal className={styles.content}>
              ...
              <RevealChild>
                <div className={styles.contactLinks}>
                  <motion.a
                    href="mailto:sudheertatavalu10@gmail.com"
                  ...
                  >
                    ...
                    <span>sudheertatavalu10@gmail.com</span>
                  ...
                  <motion.a
                    href="https://www.linkedin.com/in/sudheerkumart10"
                    target="_blank"
                  ...
                  >
                    ...
                    <span>linkedin.com/in/sudheerkumart10</span>
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className={styles.arrow}>
                      <path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </motion.a>
                  ...
                  <motion.a
                    href="https://github.com/sudheerkumart10"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={styles.contactItem}
                    whileHover={{ x: 6 }}
                  >
                    ...
                    <span>github.com/sudheerkumart10</span>
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className={styles.arrow}>
                      <path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </motion.a>
